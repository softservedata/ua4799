...
public class AppStr {
    public static void main(String[] args) {
        /*-
		//char[] chA = new char[] {'A', 'B', 'C', 'D', 'E', 'F', 'H'};
        ...
        System.out.println("strNum = " + (strNum + 4) + " strNum.length() = " + strNum.length());
        */
		/*-
		...
		char c = str.charAt(8); // J str[8] not working
		...
		*/
        ...
        System.out.println("a.compareTo(A) = " + a.compareTo(A)); // 32 'a'=(char)97; 'A'=(char)65;
        ...
        */
		/*-
		String a0 = "Java"; // equals new String("Java"); + Str Pool;
